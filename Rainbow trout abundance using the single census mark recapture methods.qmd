...
The normal approximation method was used in developing the confidence interval due to its conventional use when large sample approximations are valid. This method simply offers readable techniques for estimating the confidence intervals on standard errors estimated from samples. This approach facilitates accurate prediction of the fish population in ecological surveys hence playing an important role in species management and conservation.
